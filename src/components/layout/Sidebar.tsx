  ...
  return (
    <div className="flex h-full w-full flex-col glass-strong rounded-r-2xl overflow-hidden">
      <div className="flex items-center gap-3 px-5 py-5">
        <div className="h-10 w-10 rounded-2xl bg-gradient-to-br from-violet-500 to-indigo-600 flex items-center justify-center shadow-lg shadow-violet-500/25 flex-shrink-0">
              ...
              <div key={item.label}>
                ...
                >
                  <div className={cn(
                    ...
                    isGroupActive
                      ? "bg-gradient-to-br from-violet-500/20 to-indigo-500/20 text-violet-600"
                ...
                {isOpen && (
                  <div className="ml-4 pl-4 mt-1 mb-1.5 space-y-0.5 border-l-2 border-violet-200/50 dark:border-violet-500/20">
