...
function getIslamicHolidays(year: number) {
  const holidays: Record<number, Array<{ judul: string; tanggalMulai: string; tanggalSelesai: null }>> = {
    2025: [
      ...
      { judul: "Tahun Baru Islam", tanggalMulai: "2025-07-27", tanggalSelesai: null },
    ...
    2026: [
      ...
      { judul: "Tahun Baru Islam", tanggalMulai: "2026-07-16", tanggalSelesai: null },
    ...
    2027: [
      ...
      { judul: "Tahun Baru Islam", tanggalMulai: "2027-07-06", tanggalSelesai: null },
